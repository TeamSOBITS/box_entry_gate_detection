...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('depth_range_max_x', default_value='2.5', description='Maximum depth in X direction'),
        DeclareLaunchArgument('depth_range_min_z', default_value='0.1', description='Minimum depth in Z direction'),
        DeclareLaunchArgument('depth_range_max_z', default_value='1.7', description='Maximum depth in Z direction'),
